...
@test
Scenario Outline: Login user can use Alipay and ship to US successfully.
    ...
    Then I can checkout with PaymentMethod "<alipay>"

Examples:
    | customer_info                     | sku_id  | shipping_address                                                                                   |shipping_method| alipay|
    | karinzhang1@aaxischina.com,123456 | R53491715 |  karin,zhang,United States,California,Los Angeles,1900 Avenue of the Stars,Suite 555,90067,12122 |Ground         |Alipay |